                            ...
                            builder: (BuildContext context) {
                              return Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: Color.fromARGB(255, 206, 241, 252),
  ...
  child: Column(
                  ...
                  Padding(
                    ...
                    child: Align(alignment: Alignment.centerLeft,
                        child: Text("All Products",style: TextStyle(color: Colors.blueAccent,fontWeight: FontWeight.w900,fontSize: 20))),
                  ),
                  Flexible(
                      child: Padding(
                                    ...
                                    child:  Stack(
                                      children: [
                                        ...
                                        Positioned(
                                            top: 150,
                                            left: 10,
                                            child: Text("Rs.${p.price}",style: TextStyle(fontWeight: FontWeight.w800,color: Colors.blueAccent,fontSize: 14),)),
                                        Positioned(
                                            bottom: 5,
                                            right: 5,
                                            child: Container(width: 80,
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  ...
                                                  decoration: BoxDecoration(
                                                    color:  Color.fromARGB(255, 15, 31, 66),
                                                    border: Border.all(
                                                      width: .5,
                                                    ),
