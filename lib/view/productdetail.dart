import 'package:ecommerce_app/service/databasehelper.dart';
        ...
        child: ListView(
          ...
          children: [
                      ...
                      child: Container(height: 25,width: 100,
                        ...
                        child: Center(child: Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 5,),
                            Text('${widget.product.rating}',style: TextStyle(color: Colors.blueAccent,fontWeight: FontWeight.w800),),
                          ],
                        )),))
                ],),
                height: 300,
            ...
            Padding(
              ...
              child: Align(
                  alignment: Alignment.centerLeft,
                  child: Text("Rs : ${widget.product.price}",style: TextStyle(fontWeight: FontWeight.w800,color: Colors.blueAccent,fontSize: 18),)),
            ),
            Padding(
              padding: const EdgeInsets.only(left: 8.0),
              child: Align(
